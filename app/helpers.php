...
{
    return SuperAdminSetting::where('key', $key)->value('value');
}
...
function isSubscriptionExpired()
{
    ...
    return [
        'status'  => $subscriptionEndDate->diffInDays($currentDate) <= getSuperAdminSettingValue('plan_expire_notification'),

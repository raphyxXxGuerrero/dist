            ...
            <div class="d-flex flex-wrap flex-sm-nowrap mb-3">
                <div class="me-7 mb-4">
                    <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                        <img src="{{ $ipdPatientDepartment->patient->user->image_url }}" class="object-fit-cover" alt="image"/>
                    </div>
                </div>
                ...
                <div>
                    <div class="card-body  border-top p-9">
                        <div class="row mb-7">
                            ...
                            <div class="col-lg-8">
                                <span
                                    class="badge badge-light-info">{{ !empty($ipdPatientDepartment->case_id) ? $ipdPatientDepartment->patientCase->case_id : __('messages.common.n/a') }}</span>
                            </div>
                        </div>
                        <div class="row mb-7">
                        ...
                        <div class="row mb-7">
                            ...
                            <div class="col-lg-8">
                                <span
                                        ...
                                        title="{{ \Carbon\Carbon::parse($ipdPatientDepartment->admission_date)->diffForHumans() }}">{{ date('jS M, Y h:i', strtotime($ipdPatientDepartment->admission_date)) }}</span>
                            </div>
                        </div>
                        <div class="row mb-7">
                            <label
                        ...
                        <div class="row mb-7">
                            ...
                            <div class="col-lg-8">
                                <span
                                    class="fw-bolder fs-6 text-gray-800 me-2">{{ !empty($ipdPatientDepartment->updated_at) ? $ipdPatientDepartment->updated_at->diffForHumans() : __('messages.common.n/a') }}</span>
                            </div>
                        </div>
                        <div class="row mb-7">

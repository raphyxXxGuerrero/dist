...
<head>
    ...
    <link rel="icon"
          href="{{ !getLoggedInUser()->hasRole('Super Admin') ? asset(getSettingValue('favicon')) : asset(getSuperAdminSettingValue('favicon')) }}"
          type="image/png">
            ...
            <div class="content d-flex flex-column flex-column-fluid content-padding-top" id="kt_content">
                ...
                <div class="post d-flex flex-column-fluid" id="kt_post">
                    <div id="kt_content_container" class="container">
                        @if(getLoggedInUser()->hasRole('Admin') && isSubscriptionExpired()['status'])
...
@yield('page_scripts')
<script>
    let defaultImage = '{{asset('web_front/images/main-banner/banner-one/woman-doctor.png')}}';

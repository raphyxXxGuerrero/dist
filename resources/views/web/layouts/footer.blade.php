            ...
            <div class="col-lg-3 col-md-6">
                <div class="single-footer-widget">
                    <div class="widget-logo">
                        <a href="{{ route('front', getUser()->username) }}"><img src="{{ getLogoUrl() }}"
                                                                                 alt="image"></a>
                    </div>
            ...
            <div class="col-lg-3 col-sm-6 d-lg-block d-sm-none d-block">
                <div class="single-footer-widget ps-5">
                    ...
                    <ul class="quick-links">
                        <li>
                            <a href="{{ route('front', getUser()->username) }}">{{ __('messages.web_home.home') }}</a>
                        </li>
                        <li>
                            <a href="{{ route('our-services', getUser()->username) }}">{{ __('messages.web_home.services') }}</a>
                        </li>
                        <li>
                            <a href="{{ route('our-doctors', getUser()->username) }}">{{ __('messages.web_home.doctors') }}</a>
                        </li>
                        <li>
                            <a href="{{ route('aboutUs', getUser()->username) }}">{{ __('messages.web_menu.about') }}</a>
                        </li>
                        <li>
                            <a href="{{ route('contact', getUser()->username) }}">{{ __('messages.web_home.contact') }}</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-sm-6 d-lg-none d-sm-block d-none">
                <div class="single-footer-widget ps-5">
                    ...
                    <ul class="quick-links">
                        ...
                        <li>
                            <a href="{{ route('aboutUs', getUser()->username) }}l">{{ __('messages.web_menu.about') }}</a>
                        </li>
                        <li>
                            <a href="{{ route('contact', getUser()->username) }}">{{ __('messages.web_home.contact') }}</a>
                        </li>

                ...
                <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                    <ul class="navbar-nav m-auto">
                        ...
                        <li class="nav-item {{ Route::currentRouteName() == 'our-doctors' ? 'active' : '' }}">
                            <a href="{{ route('our-doctors', getUser()->username) }}"
                        ...
                        <ul class="dropdown-menu">
                            <li class="nav-item {{ Route::currentRouteName() == 'appointment' ? 'active' : '' }}">
                                    <a href="{{ route('appointment', getUser()->username) }}"
                                       class="nav-link {{ Request::is('appointment', getUser()->username) ? 'active' : '' }}">{{ __('messages.web_menu.appointment') }}</a>
                                </li>

                                <li class="nav-item {{ Route::currentRouteName() == 'working-hours' ? 'active' : '' }}">
                                    <a href="{{ route('working-hours', getUser()->username) }}"
                                ...
                                <li class="nav-item {{ Route::currentRouteName() == 'testimonials' ? 'active' : '' }}">
                                    <a href="{{ route('testimonials', getUser()->username) }}"
                                ...
                                <li class="nav-item {{ Route::currentRouteName() == 'terms-of-service' ? 'active' : '' }}">
                                    <a href="{{ route('terms-of-service', getUser()->username) }}"
                                ...
                                <li class="nav-item {{ Route::currentRouteName() == 'privacy-policy' ? 'active' : '' }}">
                                    <a href="{{ route('privacy-policy', getUser()->username) }}"
                    ...
                    <div class="others-options d-flex align-items-center">
                        ...
                        @endif
                        <div class="option-item">
                            <form action="{{route('appointment', getUser()->username)}}" class="book-appointment-form"
                                  method="POST">
                                @csrf
                                <button type="submit"

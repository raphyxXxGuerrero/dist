            ...
            <div class="d-flex flex-wrap flex-sm-nowrap mb-3">
                <div class="me-7 mb-4">
                    <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                        <img src="{{ $opdPatientDepartment->patient->user->image_url }}" class="object-fit-cover" alt="image"/>
                    </div>
                </div>
                        ...
                        <div class="row mb-7">
                            <label
                                class="col-lg-4 fw-bold text-muted">{{ __('messages.case.case_id')  }}</label>
                                    <div class="col-lg-8">
                                <span
                                    class="badge badge-light-info">{{ !empty($opdPatientDepartment->case_id) ? $opdPatientDepartment->patientCase->case_id : __('messages.common.n/a') }}</span>
                                    </div>
                                </div>
                                <div class="row mb-7">
                                    <label
                        ...
                        <div class="row mb-7">
                            ...
                            <div class="col-lg-8">
                                <span
                                        ...
                                        title="{{ \Carbon\Carbon::parse($opdPatientDepartment->appointment_date)->diffForHumans() }}">{{ date('jS M, Y h:i', strtotime($opdPatientDepartment->appointment_date)) }}</span>
                            </div>
                        </div>
                        <div class="row mb-7">
                            <label
                            ...
                            <div class="col-lg-8 d-flex align-items-center">
                                ...
                                <div class="row mb-7">
                                    <label class="col-lg-4 fw-bold text-muted">{{ __('messages.ipd_payments.payment_mode') }}</label>
                                    <div class="col-lg-8">
                                <span
                                ...
                                <div class="row mb-7">
                                    <label class="col-lg-4 fw-bold text-muted">{{ __('messages.doctor_opd_charge.standard_charge') }}</label>
                                    <div class="col-lg-8">
                                <span
                                ...
                                <div class="row mb-7">
                                    <label
                                        class="col-lg-4 fw-bold text-muted">{{ __('messages.ipd_patient.notes') }}</label>
                                    <div class="col-lg-8 d-flex align-items-center">
                                <span
                    ...
                    <div class="card-title m-0">
                        <h3 class="fw-bolder m-0">{{ __('messages.visitors') }}</h3>
                            ...
                            <div class="card-title">
                                <a href="{{ route('opd.patient.create').'?revisit='.$opdPatientDepartment->id }}" class="btn btn-primary">

                        ...
                        <div class="contact-media">
                            <div class="d-flex align-items-center mb-5">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    ...
                                    <p>{{ getSuperAdminSettingValue('address') }}</p>
                                </div>
                            </div>
                            <div class="d-flex align-items-center mb-5">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    ...
                                    <a href="mailto:{{ getSuperAdminSettingValue('email') }}">{{ getSuperAdminSettingValue('email') }}</a>
                                </div>
                            </div>
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    ...
                                    <a href="tel:{{ getSuperAdminSettingValue('phone') }}">{{ getSuperAdminSettingValue('phone') }}</a>
                                </div>
                            </div>
                        </div>
                    </div>

<div class="col-xl-4 my-4">
    <div class="price-table h-100 pricing-section">
        ...
        <div class="price-list">
            <ul class="list-unstyled">
                @if (getLoggedInUser() != null && count($subscriptionsPricingPlan->subscription) > 0)
                    @if(getCurrentActiveSubscriptionPlan()->trial_ends_at != null && getCurrentActiveSubscriptionPlan()->subscription_plan_id == $subscriptionsPricingPlan->id)
                        <li>
        ...
        @if(isAuth() && $subscriptionsPricingPlan->id == currentActiveSubscription()->subscription_plan_id && !currentActiveSubscription()->isExpired())
            ...
            @endif
        @else
            @if(isAuth() && !currentActiveSubscription()->isExpired() && ($subscriptionsPricingPlan->price == 0 || $subscriptionsPricingPlan->price != 0))

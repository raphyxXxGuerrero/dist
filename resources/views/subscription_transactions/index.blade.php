...
@section('content')
    ...
    <div class="card">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true"
                            ...
                            <div class="px-7 py-5">
                                <div class="mb-10">
                                    ...
                                    {{ Form::select('payment-type',['' => 'All'] + $paymentTypes,null, ['id' => 'paymentTypeArr', 'data-control' =>'select2', 'class' => 'form-select form-select-solid status-selector select2-hidden-accessible data-allow-clear="true"']) }}
                                </div>
        ...
        <div class="card-body pt-0 fs-6 py-8 px-8  px-lg-10 text-gray-700">
            @include('subscription_transactions.table')
        </div>

            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                <div class="row">
                    <div class="form-group col-sm-12 mb-5">
                        ...
                        {{ Form::text('consultation_title', null, ['class' => 'form-control edit-consultation-title form-control-solid','required']) }}
                    </div>
                    <div class="form-group col-sm-6 mb-5">
                        ...
                        {{ Form::text('consultation_date', null, ['class' => 'form-control edit-consultation-date form-control-solid','required', 'autocomplete' => 'off']) }}
                    </div>
                    <div class="form-group col-sm-6 mb-5">
                    ...
                    <div class="form-group col-sm-6 mb-5">
                        ...
                        {{ Form::select('patient_id', $patients, null, ['class' => 'form-select form-select-solid edit-patient-name', 'placeholder' => 'Select Patient Name', 'id' => 'editPatientName', 'required', 'data-control'=>'select2']) }}
                    </div>
                    <div class="form-group col-sm-6 mb-5">
                        {{ Form::label('doctor_id', __('messages.blood_issue.doctor_name').(':'), ['class' => 'form-label required fs-6 fw-bolder text-gray-700 mb-3']) }}
                        {{ Form::select('doctor_id', $doctors, null, ['class' => 'form-select form-select-solid edit-doctor-name', 'placeholder' => 'Select Doctor Name', 'required', 'id' => 'editDoctorName','data-control'=>'select2']) }}
                    </div>
                    <div class="form-group col-sm-6 mb-5">
                        {{ Form::label('type', __('messages.live_consultation.type').(':'), ['class' => 'form-label required fs-6 fw-bolder text-gray-700 mb-3']) }}
                        {{ Form::select('type', $type, null, ['class' => 'form-select form-select-solid edit-consultation-type', 'placeholder' => 'Select Type', 'disabled', 'required', 'id' => 'editConsultationType','data-control'=>'select2']) }}
                    </div>
                    <div class="form-group col-sm-6 mb-5">
                        {{ Form::label('type_number', __('messages.live_consultation.type_number').(':'), ['class' => 'form-label required fs-6 fw-bolder text-gray-700 mb-3']) }}
                        {{ Form::select('type_number', [null], null, ['class' => 'form-select form-select-solid select2Selector edit-consultation-type-number', 'placeholder' => 'Select Type', 'disabled', 'required','data-control'=>'select2']) }}
                    </div>
                    <div class="form-group col-sm-6 mb-5">
                    ...
                    <div class="form-group col-sm-6 mb-5">
                        ...
                        <span class="form-check form-check-custom form-check-solid is-valid form-check-sm">
                            ...
                            <label
                                class="form-label fs-6 fw-bolder text-gray-700 m-3">{{ __('messages.account.credit') }}</label>

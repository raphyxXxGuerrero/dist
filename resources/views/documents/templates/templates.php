<script id="DocumentActionTemplate" type="text/x-jsrender">
   <a title="<?php echo __('messages.common.edit') ?>" data-id={{:id}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1 edit-btn">
 ...
 <a title="<?php echo __('messages.common.save'); ?>" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm" href="{{:downloadLink}}" download>

...
Route::prefix('h/{username}')->group(function () {
    Route::group(['middleware' => ['setLanguage', 'xss', 'setTenantFromUsername']], function () {
        ...
        Route::post('/appointment', 'Web\WebController@appointment')->name('appointment');
...
Route::group([
    'middleware' => [
        'auth', 'verified', 'xss', 'multi_tenant', 'checkUserStatus', 'check_subscription', 'check_super_admin_role',
    ],
],
    function () {
            ...
            function () {
                Route::group(['prefix' => 'employee', 'namespace' => 'Employee'], function () {
                    Route::get('notice-board',
                        'NoticeBoardController@index')->name('noticeboard')->middleware('modules');
    ...
    Route::group(['middleware' => ['role:Admin|Patient|Doctor', 'check_menu_access']], function () {
        Route::resource('documents', 'DocumentController');
        Route::get('documents', 'DocumentController@index')->name('documents.index')->middleware('modules');
        Route::post('documents/{document}/update', 'DocumentController@update')->name('documents.update');
    });
    ...
    Route::group(['middleware' => ['role:Admin|Doctor|Receptionist|Accountant|Patient']], function () {
        Route::get('doctors/{doctor}', 'DoctorController@show')->where('doctor', '[0-9]+');
    });

        Route::group(['middleware' => ['role:Admin|Patient|Doctor|Receptionist|Nurse', 'check_menu_access']],
            function () {
                Route::resource('appointments', 'AppointmentController');
                Route::get('appointments',
                    'AppointmentController@index')->name('appointments.index')->middleware('modules');
                Route::post('appointments/{appointment}',
                    'AppointmentController@update')->name('patient.appointment.update');
                Route::get('doctors-list', 'AppointmentController@getDoctors')->name('doctors.list');
                Route::get('appointment-calendars',
                    'AppointmentCalendarController@index')->name('appointment-calendars.index');
                Route::get('calendar-list', 'AppointmentCalendarController@calendarList')->name('calendar-list');
        ...
        Route::group(['middleware' => ['role:Admin|Receptionist|Patient', 'check_menu_access']], function () {
    ...
    Route::group(['middleware' => ['role:Admin|Doctor|Receptionist|Patient']], function () {
        Route::get('doctor-departments/{id}', 'DoctorDepartmentController@show')
    ...
    Route::group(['middleware' => ['role:Admin|Receptionist|Case Manager']], function () {
        ...
        // Routes for Mail
        Route::get('mail', 'MailController@index')->name('mail')->middleware('modules', 'check_menu_access');
        Route::post('send-mail', 'MailController@store')->name('mail.send')->middleware('check_menu_access');
        ...
        Route::group([
            'middleware' => [
                'role:Admin|Receptionist|Case Manager|Doctor|Accountant|Pharmacist', 'check_menu_access',
            ],
        ], function () {
            //Sms Rout
...
//        Route::post('departments/{department}/active-deactive', 'DepartmentController@activeDeactiveDepartment');
        ...
        Route::get('dashboard',
            'HomeController@dashboard')->name('dashboard')->withoutMiddleware(['check_subscription']);
        ...
        Route::post('accountants/{accountant}/active-deactive',
            'AccountantController@activeDeactiveStatus')->name('accountant.status');
        ...
        Route::get('users-list',
            'DepartmentController@getUsersList')->name('users.list')->middleware('check_menu_access');
    ...
    Route::group(['middleware' => ['role:Admin|Doctor|Receptionist|Lab Technician']], function () {
        ...
        Route::group([
            'middleware' => [
                'role:Admin|Patient|Doctor|Receptionist|Accountant|Case Manager|Nurse', 'check_menu_access',
            ],
        ],
            function () {
                Route::get('document-download/{document}',
                    'DocumentController@downloadMedia')->name('document.download');
            });
    ...
    Route::group(['middleware' => ['role:Admin|Doctor']], function () {
        Route::get('investigation-download/{investigationReport}',
            'InvestigationReportController@downloadMedia')->name('investigation.reports.download');
    });
    ...
    Route::group(['middleware' => ['role:Admin|Receptionist']], function () {
        ...
        Route::group([
            'middleware' => [
                'role:Admin|Patient|Doctor|Receptionist|Nurse|Accountant|Lab Technician|Pharmacist|Case Manager',
                'check_menu_access',
            ],
        ],
            function () {
        ...
        Route::group(['middleware' => ['role:Admin|Patient|Doctor', 'check_menu_access']],
            function () {
                //  Live Consultation
...
Route::get('feature-availability', 'HomeController@featureAvailability')->name('feature.available');

Route::group([
    'middleware' => [
        'auth', 'verified', 'xss', 'multi_tenant', 'checkUserStatus',
        'role:Admin',
    ],
], function () {
...
Route::group([
    'prefix'     => 'super-admin',
    'middleware' => ['auth', 'verified', 'xss', 'role:Super Admin', 'checkUserStatus', 'check_impersonate'],
], function () {
    Route::get('dashboard', 'HomeController@superAdminDashboard')->name('super.admin.dashboard');
    Route::post('hospitals/{id}/is-verified', 'UserController@isVerified')->name('users.verified');
    Route::post('hospitals/{id}/active-deactive', 'UserController@activeDeactiveStatus')->name('users.status');

    Route::get('hospitals', 'UserController@index')->name('super.admin.hospitals.index');
    Route::get('hospitals-index', 'UserController@hospitalIndex')->name('super.admin.hospitals.datatable.index');
    Route::get('hospital-billing', 'HospitalController@billingIndex')->name('super.admin.hospital.billing.index');
    Route::get('hospital-billing-modal/{id}',
        'HospitalController@billingModal')->name('super.admin.hospital.billing.modal');
    Route::get('hospital-transaction',
        'HospitalController@transactionIndex')->name('super.admin.hospital.transaction.index');
    ...
    // Impersonate Login
    Route::get('hospitals/{user}/login', 'UserController@userImpersonateLogin');

    //Landing CMS
    Route::get('section-one', 'Landing\SectionOneController@index')->name('super.admin.section.one');
    Route::put('section-one/update', 'Landing\SectionOneController@update')->name('super.admin.section.one.update');
    Route::get('section-two', 'Landing\SectionTwoController@index')->name('super.admin.section.two');
    Route::put('section-two/update', 'Landing\SectionTwoController@update')->name('super.admin.section.two.update');
    Route::get('section-three', 'Landing\SectionThreeController@index')->name('super.admin.section.three');
    Route::put('section-three/update',
        'Landing\SectionThreeController@update')->name('super.admin.section.three.update');
    Route::get('section-four', 'Landing\SectionFourController@index')->name('super.admin.section.four');
    Route::put('section-four/update', 'Landing\SectionFourController@update')->name('super.admin.section.four.update');
    Route::get('section-five', 'Landing\SectionFiveController@index')->name('super.admin.section.five');
    Route::put('section-five/update', 'Landing\SectionFiveController@update')->name('super.admin.section.five.update');
    Route::resource('admin-testimonial', 'Landing\AdminTestimonialController');
    Route::post('admin-testimonial/{id}',
        'Landing\AdminTestimonialController@update')->name('admin-testimonial.update');
    Route::get('about-us', 'Landing\AboutUsController@index')->name('super.admin.about.us');
    Route::put('about-us/update', 'Landing\AboutUsController@update')->name('super.admin.about.us.update');
    Route::resource('service-slider', 'Landing\ServiceSliderController');
    Route::post('service-slider/{id}', 'Landing\ServiceSliderController@update')->name('service-slider-update');
    Route::resource('faqs', 'FaqsController');
    Route::post('faqs/{faqs}', 'FaqsController@update')->name('faqs-update');
    // Subscribers Route
    Route::get('subscribers', 'Landing\SubscribeController@index')->name('super.admin.subscribe.index');
    Route::delete('subscribers/{subscribe}',
        'Landing\SubscribeController@destroy')->name('super.admin.subscribe.destroy');

    // settings routes
    Route::get('general-settings', 'SettingController@editSuperAdminSettings')->name('super.admin.settings.edit');
    Route::post('general-settings', 'SettingController@updateSuperAdminSettings')->name('super.admin.settings.update');
    Route::get('footer-settings',
        'SettingController@editSuperAdminFooterSettings')->name('super.admin.footer.settings.edit');
    Route::post('footer-settings',
        'SettingController@updateSuperAdminFooterSettings')->name('super.admin.footer.settings.update');

    //Enquiry Route
    Route::get('enquiries', 'SuperAdminEnquiryController@index')->name('super.admin.enquiry.index');
    Route::delete('enquiries/{enquiry}', 'SuperAdminEnquiryController@destroy')->name('super.admin.enquiry.destroy');
    Route::get('enquiries/{enquiry}', 'SuperAdminEnquiryController@show')->name('super.admin.enquiry.show');
...
// Impersonate Logout
Route::get('/users/impersonate-logout', 'UserController@userImpersonateLogout')->name('impersonate.userLogout');
